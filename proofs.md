...
GeneratePoSt
 (
  ...
  commRs         [][32]byte,  // the commR commitments corresponding to the sealed sectors to prove
...
VerifyPoSt
 (
  ...
  commRs        [][32]byte,        // the commRs provided to GeneratePoSt 
