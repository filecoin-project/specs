...
func WinSDRParams(registeredProof abi.RegisteredProof) *WinStackedDRG_I {
...
func (sdr *WinStackedDRG_I) _generateCandidate(postCfg PoStInstanceCfg, randomness abi.PoStRandomness, aux sector.PersistentProofAux, sectorID abi.SectorID, sectorChallengeIndex uint64) abi.PoStCandidate {
	...
	var registeredProof abi.RegisteredProof

	// FIXME: Need to get registeredProof!

	candidate := abi.PoStCandidate{
		PartialTicket:  partialTicket,
		PrivateProof:   privateProof.externalize(registeredProof),
		SectorID:       sectorID,
...
func (sdr *WinStackedDRG_I) VerifyInternalPrivateCandidateProof(postCfg PoStInstanceCfg, p *InternalPrivateCandidateProof, challengeSeed abi.PoStRandomness, candidate abi.PoStCandidate, commRLast Commitment) bool {
	cfg := postCfg.As_PoStCfgV1()
...
func (sdr *WinStackedDRG_I) VerifyPrivatePoStProof(cfg PoStInstanceCfg, privateProof PrivatePoStProof, candidates []abi.PoStCandidate, sectorIDs []abi.SectorID, sectorCommitments sector.SectorCommitments) bool {
...
func (sdr *WinStackedDRG_I) _createPoStCircuitProof(privateProof PrivatePoStProof) abi.PoStProof {
	panic("TODO")
