...
{{<hd 1 "Important concepts and definitions">}}
...
{{<hd 2 "Running a leader election">}}
...
{{<hd 3 "A note on miners' 'power fraction'">}}
...
{{<hd 2 "Selecting between TipSets with equal weight">}}
