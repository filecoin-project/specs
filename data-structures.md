...
type Ticket struct {
  ...
  ## The VRFProof (pi_string in the RFC) is generated by running our VRF on a past ticket in the ticket chain using the miner's keypair.
...
type ElectionProof struct {
  ## The VRFProof is generated by running our VRF on a past ticket in the ticket chain using the miner's keypair.
  ## 97 Bytes long (may be compressible to 80)
  VRFProof Bytes
}
```
