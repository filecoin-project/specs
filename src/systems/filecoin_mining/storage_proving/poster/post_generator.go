...
func (pg *PoStGenerator_I) GeneratePoStCandidates(postCfg sector.PoStCfg, challengeSeed util.Randomness, candidateCount int, sectors []sector.SectorID, sectorStore sector_index.SectorStore) []sector.PoStCandidate {
