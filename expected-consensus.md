...
The data structure for tickets in EC can be found in the [data-structures specification](https://github.com/filecoin-project/specs/blob/master/data-structures.md).
